...
const POSTS = [
  ...
  },
  {
    ...
    body: [
      { p: { en: 'In August 2025 I spent a month at Nara Women’s University for the Summer Program on Mathematical Modeling, run by Professor Fugo Takasu with Fajar Adi Kusumo and Nanang Susyanto from UGM helping out. Everything was in English. People were patient with my accent. For four weeks my only job was figuring out how populations change over time.', vi: 'Tháng 8 năm 2025 tôi qua Đại học Nữ sinh Nara một tháng, tham gia Summer Program on Mathematical Modeling do thầy Fugo Takasu tổ chức, có Fajar Adi Kusumo với Nanang Susyanto từ UGM phụ. Toàn bộ bằng tiếng Anh. Mọi người kiên nhẫn với accent của tôi lắm. Bốn tuần đó việc duy nhất của tôi là hiểu quần thể thay đổi theo thời gian kiểu gì.' } },
      { img: 'assets/ps-09.jpeg', cap: 'Nara Women’s University, morning' },
      { p: { en: 'Campus is half old wood, half concrete, depending which part you’re standing in. Every morning I walked past a noticeboard full of club posters I couldn’t read and photographed it anyway — kyudo, handball, a choir, a radio station. There’s probably a math modeling club on that wall somewhere too, I just never found it.', vi: 'Trường thì nửa gỗ cũ nửa bê tông, tuỳ đứng chỗ nào. Sáng nào đi ngang cũng thấy cái bảng tin dán đầy poster câu lạc bộ mà tôi đọc không nổi, vẫn chụp lại. Kyudo, handball, một dàn hợp xướng, một đài phát thanh. Chắc đâu đó trên bức tường đó cũng có câu lạc bộ mô hình hoá toán học, chỉ là tôi chưa tìm ra thôi.' } },
      ...
      { p: { en: 'We started where every population dynamics course starts: one species, one equation, no space involved. Population size $N$ is just a non-negative real number, and everything you want out of the model is buried in the per capita growth rate.', vi: 'Bắt đầu từ chỗ khoá nào về động lực quần thể cũng bắt đầu: một loài, một phương trình, không có không gian. Kích thước quần thể $N$ chỉ là một số thực không âm, và mọi thứ muốn biết đều nằm trong tốc độ tăng trưởng trên mỗi cá thể.' } },
      { math: '$$\\frac{dN}{dt} = f(N)\\,N$$' },
      { img: 'assets/lecture.jpeg', cap: 'Non-spatial models, day one' },
      { p: { en: 'Pick $f(N) = \\lambda(1 - N/K)$ and you get the logistic equation — the first model in the whole subject that behaves like a real thing, growth slowing down as it gets close to carrying capacity. It has a closed-form solution too, and Professor Takasu made us derive it by hand instead of just quoting it at us.', vi: 'Chọn $f(N) = \\lambda(1 - N/K)$ là ra phương trình logistic — mô hình đầu tiên trong môn này thật sự giống một thứ có thật, tăng trưởng chậm dần khi gần chạm khả năng chịu tải. Nó cũng có nghiệm dạng đóng, và thầy Takasu bắt tự suy ra bằng tay chứ không cho chép lại.' } },
      { math: '$$N(t) = \\frac{N_0 K}{N_0 + (K - N_0)e^{-\\lambda t}}$$' },
      { img: 'assets/notes.jpeg', cap: 'Separating variables, badly, in a spiral notebook' },
      { p: { en: 'This is the page where I did it. Partial fractions, a log, an integration constant I renamed twice because I kept confusing myself, and at the bottom the answer with my name next to it — like I’d discovered something, when really it’s in every textbook ever written on this.', vi: 'Đây là trang tôi làm bài đó. Phân tích phân số đơn giản, một log, một hằng số tích phân tôi đổi tên tới hai lần vì tự làm rối mình, và cuối trang là đáp án với tên tôi ghi kế bên — như thể vừa khám phá ra cái gì to tát, trong khi nó nằm trong mọi giáo trình.' } },
      { p: { en: 'Later Fajar took us into eco-epidemiology — three species now, a pest that can get infected, a predator eating both of them. The board was covered in eigenvectors, the screen had a system on it that I couldn’t have written down four weeks before.', vi: 'Sau đó Fajar dẫn vào sinh thái - dịch tễ — giờ là ba loài, một loài gây hại có thể bị nhiễm bệnh, một loài ăn thịt ăn cả hai loài kia. Bảng đầy vector riêng, màn hình là một hệ mà bốn tuần trước tôi chịu, không viết ra nổi.' } },
      ...
      { p: { en: 'Everyone warns you about the deer before you go. Nothing prepares you for how unbothered they actually are. They just sit on the slope behind the buildings like they’re waiting for class to let out. This one stared at me for a while and decided I wasn’t food.', vi: 'Ai cũng dặn trước về mấy con hươu, nhưng chẳng ai chuẩn bị tinh thần nổi cho việc chúng tỉnh bơ cỡ nào. Chúng nằm trên dốc sau mấy toà nhà như đang đợi hết tiết. Con này nhìn tôi một hồi rồi kết luận tôi không phải đồ ăn.' } },
      ...
      { p: { en: 'Lunch was basically the same every day — one grilled thing, a mountain of shredded cabbage, rice, tea. Ate it for a month straight, never got sick of it.', vi: 'Bữa trưa gần như ngày nào cũng y hệt nhau — một món nướng, một núi bắp cải thái sợi, cơm, trà. Ăn liền một tháng mà không chán.' } },
      { h: { en: 'August 4th', vi: 'Ngày 4 tháng 8' }, id: 'nara-birthday' },
      { p: { en: 'My birthday fell in the middle of the program. Didn’t tell anyone. Watched All About Lily Chou-Chou instead — a movie about a singer who doesn’t exist and the teenagers who need her to — and later, on a trip with the other students, bought myself a secondhand console in a shop full of yellow price tags. Happy birthday to me: ¥17,800, one week of warranty.', vi: 'Sinh nhật tôi rơi vào giữa chương trình. Không nói với ai. Thay vào đó xem All About Lily Chou-Chou — phim về một ca sĩ không có thật và mấy đứa tuổi teen cần cô ấy phải có thật — rồi sau đó, trong một chuyến đi cùng mấy bạn khác, tự mua cho mình một cái máy chơi game cũ trong tiệm dán toàn nhãn giá vàng. Chúc mừng sinh nhật, 17.800 yên, bảo hành một tuần.' } },
      ...
      { p: { en: 'Afternoons I walked. No real plan, just up some path into the trees until it hit a shrine, then back down before dark. This is the only photo of myself from that whole month I actually like — took it myself, at some small shrine I found because I got lost.', vi: 'Buổi chiều tôi đi bộ. Không định trước gì, cứ theo một con đường lên rừng cho tới khi gặp một ngôi đền, rồi đi xuống trước khi trời tối. Đây là tấm ảnh duy nhất của tôi cả tháng đó mà tôi thấy được — tự chụp, ở một ngôi đền nhỏ tìm được nhờ đi lạc.' } },
      ...
      { p: { en: 'Nobody photographs the town itself. Vending machines outside a shuttered shop. A clothes rack sitting half in the sun. The station at night, three people waiting for a bus. I like this stuff more than the temples, honestly.', vi: 'Chẳng ai chụp bản thân cái thị trấn. Mấy cái máy bán hàng tự động trước một tiệm đã đóng cửa. Một giá treo đồ nằm nửa trong nắng. Nhà ga ban đêm, ba người đứng chờ xe buýt. Thật ra tôi thích mấy cái này hơn mấy ngôi chùa.' } },
      ...
      { p: { en: 'Weekends we went to Osaka. Everyone photographing the castle while photographing the castle. A souvenir shop where I stood way too long staring at a wall of fox masks. An aquarium where a friend and I wasted an unreasonable amount of time watching jellyfish do nothing.', vi: 'Cuối tuần cả nhóm ra Osaka. Toà thành, ai cũng đang chụp toà thành trong lúc mình cũng đang chụp toà thành. Một tiệm quà lưu niệm nơi tôi đứng lâu quá mức trước một bức tường mặt nạ cáo. Một thuỷ cung nơi tôi với một đứa bạn phí một lượng thời gian vô lý ngồi xem sứa không làm gì cả.' } },
      ...
      { p: { en: 'There was a wall in that aquarium with a poem on it, Japanese then English — something like lives have been circling, corals have been circling, the ocean has been circling. I stood there way longer than I meant to, not sure why.', vi: 'Trong thuỷ cung đó có một bức tường ghi bài thơ, tiếng Nhật rồi tới tiếng Anh — đại khái là những sinh mệnh vẫn đang xoay vòng, những rạn san hô vẫn đang xoay vòng, đại dương vẫn đang xoay vòng. Tôi đứng đó lâu hơn dự tính, không rõ vì sao.' } },
      { img: 'assets/aquarium.jpeg', cap: '“From now on, we all are circling.”' },
      { h: { en: 'The certificate', vi: 'Tờ giấy chứng nhận' }, id: 'nara-cert' },
      { p: { en: 'At the end I presented an SIR model I built in R. Small, nothing fancy, got corrected kindly on the parameters and less kindly on my R style. Then Professor Takasu handed me a certificate in a computer room, someone snapped this photo, and that was the month, done.', vi: 'Cuối chương trình tôi trình bày một mô hình SIR viết bằng R. Nhỏ, chẳng có gì hoa mỹ, bị sửa tử tế ở phần tham số và ít tử tế hơn ở cách viết R. Rồi thầy Takasu đưa tôi tờ chứng nhận trong một phòng máy, ai đó chụp tấm này, và thế là hết một tháng.' } },
      { img: 'assets/cert.jpeg', cap: 'With Professor Fugo Takasu' },
      { p: { en: 'The certificate wasn’t really the point, if I’m honest. What stuck with me is that population biologists ask different questions of the same equations than I was trained to ask — less “solve this,” more “what does the solution actually say about something alive.”', vi: 'Tờ chứng nhận thật ra không phải điều đọng lại. Cái tôi nhớ hơn là mấy nhà sinh học quần thể hỏi khác hẳn với cùng một hệ phương trình so với cách tôi được dạy — ít quan tâm “giải ra sao”, quan tâm hơn “nghiệm này nói gì về một thứ đang sống”.' } }
    ]
  }
];
