...
const POSTS = [
  {
    ...
    body: [
      ...
      { p: { en: 'Everyone warns you about the deer before you go, but nothing really prepares you for how unbothered they are. They sit on the slope behind the buildings like they’re waiting for a lecture to end. This one looked at me for a while and decided I wasn’t food.', vi: 'Ai cũng dặn trước về mấy con hươu, nhưng chẳng gì chuẩn bị được cho việc chúng thản nhiên đến vậy. Chúng nằm trên sườn dốc sau mấy toà nhà như đang chờ hết tiết học. Con này nhìn tôi một lúc rồi quyết định tôi không phải đồ ăn.' } },
      ...
      { p: { en: 'Lunch was almost always the same: one grilled thing, a mountain of shredded cabbage, rice, tea. I ate it for a month straight and never got tired of it.', vi: 'Bữa trưa gần như lúc nào cũng vậy: một món nướng, một núi bắp cải thái sợi, cơm, trà. Tôi ăn suốt một tháng liền mà không thấy chán.' } },
      ...
      { p: { en: 'There was a wall in that aquarium with a poem on it, in Japanese and then in English: lives have been circling, corals have been circling, the ocean has been circling. I stood there longer than I meant to.', vi: 'Trong thuỷ cung đó có một bức tường ghi bài thơ, bằng tiếng Nhật rồi tiếng Anh: những sinh mệnh vẫn đang xoay vòng, những rạn san hô vẫn đang xoay vòng, đại dương vẫn đang xoay vòng. Tôi đứng đó lâu hơn dự định.' } },
